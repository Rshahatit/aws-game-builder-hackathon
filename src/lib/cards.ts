...
export const PROPERTY_COLORS: Record<PropertyColor, { name: string; hex: string }> = {
...
export const PROPERTIES: Card[] = [
  { id: 'boardwalk', type: 'property', name: 'Boardwalk', value: 4, color: 'blue' },
  { id: 'park-place', type: 'property', name: 'Park Place', value: 4, color: 'blue' },
  // Add more properties...
];
